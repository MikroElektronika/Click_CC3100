...
sbit CC3100_HIB_PIN at GPIO_PIN56_bit;//Hibernate Pin
sbit CC3100_CS_PIN at GPIO_PIN28_bit;//Chip Select Pin
sbit CC3100_RST_PIN at GPIO_PIN1_bit;//Reset Pin
...
void system_init()
{
    ...
    GPIO03_CFG0_bit = 1;                                                        // Set rising edge to detect interrupt
    GPIO03_CFG1_bit = 1;                                                        // Interrupt capable
    GPIO03_CFG2_bit = 0;                                                        // Set GPIO direction as input
    GPIO03_CFG3_bit = 0;
 ...
 *
 */
void irq_handler() iv IVT_GPIO_IRQ
{
